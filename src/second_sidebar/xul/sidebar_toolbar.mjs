...
const ICONS = {
  ...
  MORE: "chrome://browser/skin/menu.svg",
  PINNED: "chrome://newtab/content/data/content/assets/glyph-pin-16.svg",
  PINNED_ALT: "chrome://newtab/content/data/content/assets/glyph-pin-16.svg",
